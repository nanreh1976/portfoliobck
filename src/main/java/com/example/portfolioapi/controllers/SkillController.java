...
public class SkillController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SkillModel> getById(@PathVariable int id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SkillModel> update(@PathVariable int id, @Validated @RequestBody SkillModel skill) {
