...
public class RedesController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RedesModel> getById(@PathVariable int id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RedesModel> update(@PathVariable int id, @Validated @RequestBody RedesModel red) {
        if (id == red.getIdred()) {
