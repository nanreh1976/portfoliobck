...
public class ProyectoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProyectoModel> getById(@PathVariable int id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProyectoModel> update(@PathVariable int id, @Validated @RequestBody ProyectoModel proyecto) {
