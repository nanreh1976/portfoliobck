...
public class EducacionController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EducacionModel> getById(@PathVariable int id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EducacionModel> update(@PathVariable int id, @Validated @RequestBody EducacionModel educacion) {
